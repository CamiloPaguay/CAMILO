...
`;
  ...
  if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
    ...
    await conn.relayMessage(m.chat, { extendedTextMessage: { text: `${masss}\n${htextos}\n`, ...{ contextInfo: { externalAdReply: { title: '*May-Bot*', body: '𝙈𝙖𝙮-𝘽𝙤𝙩', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/HCwHgbB4GiQDQ4vmrxdjCC' } } } } }, { quoted: m });
  }
};
