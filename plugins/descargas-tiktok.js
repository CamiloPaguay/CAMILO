...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '𝗠𝗮𝘆-𝗕𝗼𝘁', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com'}, mentionedJid: [m.sender]}}}, aa);
